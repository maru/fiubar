...
class ContactForm(forms.Form):
    ...
    def __init__(self, data=None, files=None, request=None, *args, **kwargs):
        ...
        if request.user.is_authenticated():
		    self.base_fields['name'].initial = request.user.get_full_name()
		    self.base_fields['email'].initial = request.user.email
    ...
    def subject(self):
        ...
        """
        self.subject_template_name = self.request.POST.get('subject_template_name',
    ...
    def get_message_dict(self):
        ...
        self.from_email = '"%s" <%s>' % (self.cleaned_data['name'], self.cleaned_data['email'])
        message_dict = {}
