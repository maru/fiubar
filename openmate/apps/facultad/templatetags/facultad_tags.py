...
from facultad.models import PlanMateria, Alumno, Carrera, AlumnoMateria, AlumnoCurso, Materia
#from utils import templates as utils
#from event.models import EventMateria
...
def carreras_cloud(context):
	...
	cursor.execute("""
		...
		FROM facultad_alumno a, facultad_carrera c
