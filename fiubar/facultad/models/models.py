...
class Alumno(models.Model):
	...
	def url_materias(self):
		return reverse('facultad:facultad-materias-carrera', args=[self.plancarrera.short_name])

	def url_materias_tab_todas(self):
		return reverse('facultad:facultad-materias-carrera', args=[self.plancarrera.short_name]) + '?show=todas'

	def url_graduado(self):
		return reverse('facultad:carreras-graduado', args=[self.plancarrera.short_name])

	def url_del_graduado(self):
		return reverse('facultad:carrera-graduado-del', args=[self.plancarrera.short_name])
...
class Materia(models.Model):
	...
	def url_edit_materia(self):
		return reverse('facultad:facultad-materia', args=[self.id])
...
class PlanMateria(models.Model):
	...
	def url_edit_materia(self):
		return reverse('facultad:facultad-materia', args=[self.materia])
...
class Correlativa(models.Model):
	materia = models.ForeignKey(PlanMateria, related_name='materia_p', on_delete=models.CASCADE)
	correlativa = models.ForeignKey(PlanMateria, related_name='correlativa', null=True, on_delete=models.CASCADE)
