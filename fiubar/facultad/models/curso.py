...
from . import Materia, MateriaCurso
...
class MateriaCurso(models.Model):
    ...
    class Admin(admin.ModelAdmin):
        list_display = ['materia', 'codigo', 'vacantes', 'docentes',
                        'carreras', 'horarios', 'pub_date']
        search_fields = ('materia__id', 'materia__name', 'docentes',
                         'horarios')
